          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6 text-sm">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <FieldWithInfo info="Droplet or particle size if known">
                <input name="particleSize" onChange={handleChange} placeholder="Droplet Size (if any)" className="input" />
              </FieldWithInfo>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <FieldWithInfo info="Expected average droplet size">
                <input name="avgParticleSize" onChange={handleChange} placeholder="Average Droplet Size" className="input" />
              </FieldWithInfo>

              <FieldWithInfo info="Expected output yield of droplets">
                <input name="particleYield" onChange={handleChange} placeholder="Droplet Yield" className="input" />
              </FieldWithInfo>
